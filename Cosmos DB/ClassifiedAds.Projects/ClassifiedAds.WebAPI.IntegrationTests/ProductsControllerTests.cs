...
namespace ClassifiedAds.WebAPI.IntegrationTests
{
    public class ProductsControllerTests
    {
        ...
        private static async Task<Product> GetProductById(string id)
        {
        ...
        private static async Task<Product> UpdateProduct(string id, Product product)
        {
        ...
        private static async Task DeleteProduct(string id)
        {
